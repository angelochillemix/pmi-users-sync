...
class Pmi_Users_Sync_Members_Web_Service {
	...
	/**
	 * The count of members retrieve through the web service call
	 *
	 * @var integer
	 */
	...
	/**
	 * The CVS returned by the call of the web service
	 *
	 * @var string
	 */
	...
	/**
	 * The username to use for the web service call
	 *
	 * @var string
	 */
	...
	/**
	 * The password to use for the web service call
	 *
	 * @var string
	 */
	...
	/**
	 * The {@see Pmi_Users_Sync_Members_Web_Service} constructor
	 *
	 * @param string $username The username to use for the web service call.
	 * @param string $password The password to use for the web service call.
	 */
	...
	/**
	 * Returns the CSV file with the list of PMI members returned by the web service call.
	 *
	 * @return string
	 */
