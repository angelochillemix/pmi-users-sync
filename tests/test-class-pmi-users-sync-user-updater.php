...
class Test_Pmi_Users_Sync_Pmi_User_Updater extends TestCase
{
    ...
    private $pmi_ids = ['1234567', '2496408', '9876543', '1212121'];
    private $pmi_ids_difference_set = ['0123456', '2496400', '9876541', '1212111'];
    ...
    public function test_single_user_update()
    {
        ...
        Pmi_Users_Sync_User_Updater::update(array($user_ciccio_bello), $options);
